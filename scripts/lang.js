const translations = {
  en: {
    ...
    proj2Text: "A university platform for managing courses, grades, and communication, featuring announcements, forums, tasks, and file management. Supports roles: Professor, Student, Admin Staff, and Admin. Built with Angular and Angular Material, with a RESTful backend for data persistence and authentication. Designed for scalability and ease of use.",
  ...
  sr: {
    ...
    proj2Text: "Univerzitetska platforma za upravljanje predmetima, ocenama i komunikacijom, sa funkcijama kao što su najave, forumi, zadaci i upravljanje fajlovima. Podržava uloge: Nastavnik, Student, Služba i Admin. Napravljeno u Angular-u i Angular Material-u sa RESTful backend-om za čuvanje podataka i autentifikaciju. Dizajnirano za skalabilnost i jednostavno korišćenje.",
